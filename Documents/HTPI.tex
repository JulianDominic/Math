...
\begin{theorem}[Goal: $P \rightarrow Q$; Contrapositive]
...
\begin{theorem}[Goal: $\lnot{P}$; Contradiction]
...
\begin{theorem}[Given: $\lnot{P}$; Contradiction]
...
\begin{theorem}[Given: $P \rightarrow Q$; Rules of Inference]
...
\begin{theorem}[Goal: $\forall{x}P(x)$]
...
\begin{theorem}[Goal: $\exists{x}P(x)$]
...
\begin{theorem}[Given: $\exists{x}P(x)$]
...
\begin{theorem}[Given: $\forall{x}P(x)$]
